...
export default function BacktestClient() {
  ...
  function EquityChart() {
    ...
    const minX = Math.min.apply(null, xs as any);
    const maxX = Math.max.apply(null, xs as any);
    const minY = Math.min.apply(null, ys as any);
    const maxY = Math.max.apply(null, ys as any);
